...
<div class="max-w-7xl mx-auto p-6 flex flex-col gap-4 min-h-screen">
    ...
    <header
        class="flex items-end justify-between border-b border-drafting pb-3"
    >
        <div>
        ...
        <div class="flex items-end gap-3">
            {#if data.recipe.tags.length}
                <div
                    class="flex gap-1.5 text-[10px] uppercase tracking-wider text-obsidian/60"
                >
    ...
    {:else}
        ...
        >
            ...
            <section class="{mobileTab === 'detail' ? '' : 'hidden'} lg:block">
                {#if selected}
                    <BatchDetail
                        recipe={data.recipe}
                        batch={selected}
